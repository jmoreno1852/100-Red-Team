...
| Level 3 | Advanced Network Attacks                            | Example | URL |
| ------- | --------------------------------------------------- | ------- | --- |
...
| Level 4 | Data analysis, payloads and more networking                     | Example | URL |
| ------- | --------------------------------------------------------------- | ------- | --- |
...
| Level 5 | Cryptography, Reverse Engineering and Post exploitation                             | Example | URL |
| ------- | ----------------------------------------------------------------------------------- | ------- | --- |
